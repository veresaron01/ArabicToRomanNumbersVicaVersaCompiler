...
public class RomanToArabic {
    ...
    public LinkedHashSet<String> generateRegexes() {
        String[] s = new String[] {"(M){0,5}","(CM)?","(CD)?","(D)?","(C){0,3}","(XC)?","(XL)?","(L)?",
                "(X){0,3}","(IX)?", "(IV)?","(V)?","(I){0,3}"};
        LinkedHashSet<String> regexes = new LinkedHashSet();
    ...
    public List<String> generateRegexes2() {
